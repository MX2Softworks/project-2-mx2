/// @description  scr_saw_move_right_state()
/// @function  scr_saw_move_right_state
...
if (wall_on_right || end_of_path_right) {
    // No more room to move to the right
    
    state = scr_saw_move_left_state;
    
    // Check to see if there is room to move left
