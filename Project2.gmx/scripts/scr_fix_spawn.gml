...
if (place_meeting(x, y, obj_solid)) {
    ...
    var move_x = 0;
    var move_y = 0;
    while(position_meeting(x+x_minus, y, obj_solid)) {
        x_minus -= 1;
    }
    while(position_meeting(x+x_plus, y, obj_solid)) {
        x_plus += 1;
    }
    while(position_meeting(x, y+y_minus, obj_solid)) {
        y_minus -= 1;
    }
    while(position_meeting(x, y+y_plus, obj_solid)) {
        y_plus += 1;
    }
